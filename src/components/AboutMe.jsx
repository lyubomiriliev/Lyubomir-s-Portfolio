...
const AboutMe = () => {
  ...
  return (
    <div
      ...
      ref={ref}
    >
      <div className="max-w-screen-xl mx-auto bg-gradient-to-r relative lg:overflow-hidden h-[600px] rounded-xl lg:bg-gradient-to-r from-slate-200 via-slate-50 to-slate-200 flex flex-col md:flex-row items-center justify-between">
        <div className="w-[90%] md:w-1/2 order-1 md:order-2 h-full flex flex-col justify-start py-10 items-center">
          ...
          <p className="w-full md:w-2/3 text-center md:text-justify font-outfit font-light mt-8">
        ...
        <div className="w-full md:w-[80%] order-2 md:order-1 mt-10 md:mt-0">
          <img
            className="object-cover w-full  lg:w-2/3 absolute right-1 lg:right-[39%] -bottom-4 lg:bottom-0"
            src={aboutImage}
            alt="about image"
          />
        </div>
