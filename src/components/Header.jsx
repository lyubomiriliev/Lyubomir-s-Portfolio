...
const Header = ({ activeSession, onSectionClick }) => {
    ...
    return (
        <div className='w-full flex flex-col md:flex-row h-26 md:h-20 fixed top-0 z-50'>
            <motion.div className='w-full top-0 h-[4.5rem] border-white border-opacity-40 mx-auto flex items-center justify-between py-2 md:py-0 flex-col md:flex-row' initial={{y: -100, opacity: 0}} animate={{y: 0, opacity: 1}}>
